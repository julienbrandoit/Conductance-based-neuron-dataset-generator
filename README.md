...
See: foundational and recent work on Dynamic Input Conductances (DICs) and related dimensionality-reduction approaches:
    ...
    - Brandoit J. et al. *Fast reconstruction of degenerate populations of conductance-based neuron models from spike times.* PLOS Computational Biology, 2026.  [https://doi.org/10.1371/journal.pcbi.1014337](https://doi.org/10.1371/journal.pcbi.1014337)
