...
def generate_chunk(args):
    ...
    pop = generate_neuromodulated_population(M, V_th, g_s, g_u)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Generate DA dataset conductances via the DICs framework.")
