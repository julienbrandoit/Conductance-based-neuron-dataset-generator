...
from da import get_default_u0, get_default_parameters, simulate_individual_t_eval, ODEs, ODEs_with_noisy_current
...
def simulate_individual(conductances):
    g_Na, g_Kd, g_CaL, g_CaN, g_ERG, g_NMDA, g_leak = conductances
    t_simu = [0.0, 12000.0]
    t_transient = 3000.0
    dt = 0.05
    u0 = get_default_u0()
    ...
    args = (u0, [g_Na, g_Kd, g_CaL, g_CaN, g_ERG, g_NMDA, g_leak], t_eval, params)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Simulate DA dataset chunk.")
